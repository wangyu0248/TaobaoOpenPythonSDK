...
# <UL>
# <LI>
# <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">CName</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">淘宝客店铺搜索</SPAN>
# </LI>
# <LI>
...
class TaobaokeShopsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ''' 
        @ivar taobaoke_shops: 搜索结果列表; B{Level}: C{Object Array}; B{Required}: C{true}; B{Sample}: C{};
        ...
        ''' 
        @ivar total_results: 符合条件的店铺总数; B{Level}: C{Basic}; B{Required}: C{true}; B{Sample}: C{100};

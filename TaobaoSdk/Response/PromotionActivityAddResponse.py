...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询某个卖家的店铺优惠券领取活动。返回，优惠券领取活动ID，优惠券领取链接</SPAN>
# <UL>
# <LI>
...
class PromotionActivityAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">活动信息，包括活动id和链接</SPAN>
        # <UL>
        # <LI>
        ...
        self.activity = None
        ''' 
        @ivar activity: 活动信息，包括活动id和链接; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};

...
# <UL>
# <LI>
# <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">CName</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">取消活动</SPAN>
# </LI>
# <LI>
...
class PromotionActivityCancelResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ''' 
        @ivar is_success: true成功，false 失败; B{Level}: C{Basic}; B{Required}: C{true}; B{Sample}: C{true};

...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝客类目推广URL</SPAN>
# <UL>
# <LI>
...
class TaobaokeCaturlGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ''' 
        @ivar taobaoke_item: 只返回taobaoke_cat_click_url; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};

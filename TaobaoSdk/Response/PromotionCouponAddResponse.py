...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建店铺优惠券。有效期内的店铺优惠券总数量不超过100张</SPAN>
# <UL>
# <LI>
...
class PromotionCouponAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        self.coupon_id = None
        ''' 
        @ivar coupon_id: 优惠券的id; B{Level}: C{Basic}; B{Required}: C{true}; B{Sample}: C{123456};
        @type coupon_id: Number
        '''

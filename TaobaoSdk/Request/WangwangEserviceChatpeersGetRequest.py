...
from Response import WangwangEserviceChatpeersGetResponse


## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">获取聊天对象列表，查询时间段<=7天,只支持xml返回</SPAN>
# <UL>
# <LI>
...
class WangwangEserviceChatpeersGetRequest(object):
    def __init__(self):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询起始日期。如2010-02-01，与当前日期间隔小于3个月。</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>

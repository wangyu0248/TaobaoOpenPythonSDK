...
from Response import IncrementRefundsGetResponse
...
# <UL>
# <LI>
# <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">CName</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">获取退款变更通知信息</SPAN>
# </LI>
# <LI>
...
class IncrementRefundsGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Sample</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">RefundSuccess</SPAN>
        # </LI>
        # <LI>
